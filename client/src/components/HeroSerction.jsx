...
const HeroSection = () => {
    ...
    return (
        ...
        px-6 md:px-16 lg:px-16 bg-[url('/backgroundImage.png')]
        bg-cover bg-center h-screen">
         <img src={assets.marvelLogo} alt=" hero image" className="max-h-11 lg:h-11 mt-20"  />
        

        <h1 className="text-5xl md:text-[70px] md:leading-16 font-semibold
        max-w-110">Guadians  of the Galaxy</h1>


            <div className="flex items-center gap-4 text-gray-300">
                <span>Action  | Adventur | Sci-Fi</span>
            ...
            <p className="max-w-md text-gray-300">In a post-apocalyptic word where
